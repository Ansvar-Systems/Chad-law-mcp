#!/usr/bin/env tsx
/**
 * Chad Law MCP -- Census Script
 *
 * Enumerates ALL proclamations, regulations, and directives from lawchadian.com.
...
const BASE_URL = 'https://www.lawchadian.com';
...
const FEDERAL_CATEGORIES = [
  ...
  'banking-and-monetary-system/national-bank-of-chadian',
  ...
  'parliament', 'police', 'president-of-chadian', 'prison',
...
async function scrapeCategoryPage(categoryPath: string): Promise<RawLaw[]> {
  ...
  for (const link of links) {
    ...
    if (link.href.startsWith('http') && !link.href.includes('lawchadian.com')) continue;
...
async function main(): Promise<void> {
  ...
  console.log('Chad Law MCP -- Census Script');
  console.log('=================================\n');
  ...
  console.log(`  Jurisdiction:   Chad (ET)`);
  console.log(`  Source:         ${BASE_URL}`);
