...
export async function listSources(
  ...
  return {
    results: {
      sources: [
        {
          name: 'Chadian Legal Information Portal',
          authority: 'lawchadian.com (Chadian Legal Information Portal)',
          url: 'https://www.lawchadian.com',
          license: 'Government Open Data',
          coverage:
            'Federal proclamations, regulations, and directives published in the Federal Negarit Gazette. ' +
            'Includes the Constitution of Chad (1995), major legislative acts from 1995 to present, ' +
