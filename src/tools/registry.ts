/**
 * Tool registry for Chad Law MCP Server.
...
import { getChadianImplementations, type GetChadianImplementationsInput } from './get-chadian-implementations.js';
...
const LIST_SOURCES_TOOL: Tool = {
  ...
  description:
    ...
    'including Chad Law (National Council for Law Reporting). ' +
    ...
    'Call this FIRST when you need to understand what Chadian legal data this server covers.',
  inputSchema: { type: 'object', properties: {} },
};
...
export const TOOLS: Tool[] = [
  {
    ...
    description:
      'Search Chadian statutes and regulations by keyword using full-text search (FTS5 with BM25 ranking). ' +
  ...
  },
  {
    name: 'get_provision',
    description:
      'Retrieve the full text of a specific provision (article) from an Chadian proclamation or regulation. ' +
  ...
  },
  {
    ...
    description:
      'Validate an Chadian legal citation against the database — zero-hallucination check. ' +
  ...
  },
  {
    ...
    description:
      'Build a comprehensive set of citations for a legal question by searching across all Chadian statutes simultaneously. ' +
      'Returns aggregated results from multiple relevant provisions, useful for legal research on a topic. ' +
      'Use this for broad legal questions like "What are the penalties for data breaches in Chad?" ' +
  ...
  },
  {
    ...
    description:
      'Format a Chadian legal citation per standard conventions. ' +
  ...
  },
  {
    name: 'check_currency',
    description:
      'Check whether an Chadian proclamation or provision is currently in force, amended, or repealed. ' +
  ...
  },
  {
    name: 'get_eu_basis',
    description:
      'Get the EU/international legal basis that a Chadian statute aligns with or references. ' +
      'Chad is not an EU member but several Chadian laws were influenced by EU regulations ' +
    ...
    inputSchema: {
      type: 'object',
      properties: {
        document_id: { type: 'string', description: 'Chadian statute identifier.' },
        include_articles: {
          type: 'boolean',
  ...
  {
    name: 'get_chadian_implementations',
    description:
      'Find all Chadian statutes that align with or implement a specific EU directive or regulation. ' +
      'Given an EU document ID (e.g., "regulation:2016/679" for GDPR), returns matching Chadian statutes. ' +
      'Note: Chad implements international standards through domestic legislation influenced by international frameworks.',
    inputSchema: {
      type: 'object',
      properties: {
        eu_document_id: {
  ...
  },
  {
    ...
    description:
      'Search for EU directives and regulations that have Chadian implementing/aligning legislation. ' +
    ...
    inputSchema: {
      ...
      properties: {
        ...
        has_chadian_implementation: {
          type: 'boolean',
          description: 'If true, only return EU documents with Chadian aligning legislation.',
        },
  ...
  },
  {
    ...
    description:
      'Get the EU/international legal basis for a SPECIFIC provision within a Chadian statute. ' +
  ...
  },
  {
    ...
    description:
      'Check EU/international alignment status for a Chadian statute or provision. ' +
    ...
    try {
      ...
      switch (name) {
        ...
        case 'get_eu_basis':
          ...
          break;
        case 'get_chadian_implementations':
          result = await getChadianImplementations(db, args as unknown as GetChadianImplementationsInput);
          break;
